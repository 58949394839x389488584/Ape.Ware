...
game.StarterGui:SetCore(
    ...
    {
	Title = "Vanis.LOL ",
	Text = "Vanis.LOL, You're whitelisted.",
...
local L_4_ = L_3_.CreateLib("Vanis.LOL", "Midnight")
local L_5_ = L_4_:NewTab("Aimlock")
local L_6_ = L_5_:NewSection("Vanis.LOL")
L_6_:NewButton(
    "Aimlock",
    "Beam niggas down",
    function()
...
local L_8_ = L_7_:NewSection("Vanis.LOL")
L_8_:NewButton(
    "Silent Aim",
...
local L_10_ = L_9_:NewSection("Vanis.LOL")
L_10_:NewButton(
    "Silent Aimlock",
    "Key is Q.",
    function()
...
local L_12_ = L_11_:NewSection("Vanis.LOL")
L_12_:NewButton(
    "Anti-Lock",
    "Key is Z.",
    function()
...
local L_14_ = L_13_:NewSection("Vanis.LOL")
L_14_:NewKeybind(
    "Keybind Gui Toggle",
    "h",
    Enum.KeyCode.V,
...
local L_16_ = L_15_:NewSection("Vanis.LOL")
L_16_:NewButton(
    "Admin Base",
    "fr",
    function()
...
local L_19_ = L_17_:NewSection("Vanis.LOL")
L_19_:NewToggle(
    "ESP",
    "ESP",
    function(L_201_arg0)
